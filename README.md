...
- [wr/featherframe](https://github.com/wr/featherframe) - ESP32 e-paper frame that renders human-made 1800's art prints for the birds detected in your backyard with BirdNET or BirdWeather
...
- [TrisH0x2A/NxLite](https://github.com/TrisH0x2A/NxLite) - Lightning-fast HTTP server built in C
...
- [maxpiva/Rensaio](https://github.com/maxpiva/Rensaio) - Series Manager and Downloader, fork of the original Kaizoku
...
- [gopiashokan/Bird-Sound-Classification-using-Deep-Learning](https://github.com/gopiashokan/Bird-Sound-Classification-using-Deep-Learning) - Engineered a robust deep learning model using Convolutional Neural Networks and TensorFlow to classify 114 bird species based on audio recordings. Model achieved an impressive accuracy of 93.4%, provi
...
- [DRM-Lab/Widevine-L1](https://github.com/DRM-Lab/Widevine-L1) - Widevine L1 – Extracting Keybox from eMMC Dump (MSTAR Devices)
...
- [fabriziosalmi/DevGPT](https://github.com/fabriziosalmi/DevGPT) - Code together, right now! GPT powered code assistant to build project in minutes
...
- [angrycuban13/PSStarr](https://github.com/angrycuban13/PSStarr) - A PowerShell module to interact with Starr applications
...
- [scottbreenaus/scripts](https://github.com/scottbreenaus/scripts) - A collection of scripts for Microsoft Endpoint Manager (Intune) or related technologies (Windows, Azure AD, Graph).
...
- [GruberMarkus/Export-RecipientPermissions](https://github.com/GruberMarkus/Export-RecipientPermissions) - Document, filter and compare Exchange permissions
...
- [n0stal6ic/PlayVine](https://github.com/n0stal6ic/PlayVine) - A tool for archiving content from streaming services.
...
- [karimhabush/cyberowl](https://github.com/karimhabush/cyberowl) - Aggregates security advisories from 10 international CERTs daily and provides an AI skill that cross-references alerts against your project's tech stack.
...
- [Drop-OSS/drop-app](https://github.com/Drop-OSS/drop-app) - Moved to a monorepo at https://github.com/Drop-OSS/drop
- [lostb1t/remux-client](https://github.com/lostb1t/remux-client) - A *VERY experimental* web and desktop client for Jellyfin written in Rust
...
- [Nyumat/NyumatFlix](https://github.com/Nyumat/NyumatFlix) - Yet another MyAnimeList and TMDB metadata aggregator.
...
- [yzua/sqlite-online](https://github.com/yzua/sqlite-online) - Lightweight WebAssembly-powered SQLite viewer and editor. works entirely in your browser
